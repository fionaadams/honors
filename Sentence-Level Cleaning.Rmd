...
Sentence id, get document id to repeat over and over again
tidytext should do this?
...
```{r}
test <- rbindlist(interview_out, fill=TRUE, idcol = "id")
#great!! but how to merge horizontally
#https://stackoverflow.com/questions/14563531/combine-column-to-remove-nas
#can't get this to work! ask for help?
```
