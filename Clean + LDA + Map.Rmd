...
transcript_names <- transcripts %>% select(id, doc_id) %>% mutate(id = paste0("doc",id))

#get rid of .docx
for(i in 1:nrow(transcript_names)){
  transcript_names[2][i,] <- str_remove(transcript_names[2][i,], ".docx")
}
